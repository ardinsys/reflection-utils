...
public class ReflectionCloner extends ReflectionBase {
   ...
   *
   * @param sourceClass The class of the object to clone
   * @param targetClass The class of the cloned object
   * @param cloner      The custom cloner
   * @param <T>         The type variable of the source class
   * @param <U>         The type variable of the target class
   */
   ...
   *
   * @param sourceObject The source object to clone from
   * @param targetObject The target object to clone into
   ...
   * Clones an object.
   *
   * @param sourceObject The source object to clone
   ...
   * @param targetClass  The target class to instantiate and copy into
   * @param <T>          The type variable of the target class
