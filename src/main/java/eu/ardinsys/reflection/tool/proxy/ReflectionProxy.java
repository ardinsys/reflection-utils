...
public class ReflectionProxy extends ReflectionBase {
   ...
   *
   * @param rootObject The {@link #rootObject}
   */
   ...
   *
   * @param rootObject     The {@link #rootObject}
   * @param selectorParser The {@link #selectorParser}
   */
   ...
   * See {@link Selector}.
   *
   * @param path  A concatenated string of selectors
   * @param value The value to set in the {@link #rootObject} at the location specified by the <b>path</b> parameter
   */
